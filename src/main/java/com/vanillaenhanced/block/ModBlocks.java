...
public class ModBlocks {
    ...
    private static void registerBlockItem(String name, Block block) {
        Registry.register(Registries.ITEM, Identifier.of(VanillaEnhancedMod.MOD_ID, name), new BlockItem(block, new Item.Settings()));
    }

    //Called in the OnInitialized in VanillaEnhanced.java class
    public static void registerModBlocks() {
        VanillaEnhancedMod.LOGGER.info("Registering Mod Blocks for " + VanillaEnhancedMod.MOD_ID);
